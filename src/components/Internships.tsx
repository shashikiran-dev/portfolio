...
const Internships = () => {
  const internships = [
    ...
    
    {
      ...
      duration: "3 Months",
      description:
        "Developed a full-stack web application using Java Spring Boot for backend and React for frontend. Implemented RESTful APIs and integrated with MySQL database.",
      skills: ["Java", "Spring Boot", "React", "MySQL", "JavaScript"],
    },
    {
      role: "Python Backend Developer Intern",
      company: "CIT App Services",
      duration: "3 months",
      description:
        "Developed backend services using Python and Flask. Implemented RESTful APIs and integrated with PostgreSQL database for data management.",
